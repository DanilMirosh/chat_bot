...
# Командой start пользователь отменяет все текущие состояния и бот отправляет начальное приветствие
@rate_limit(limit=2)
...
async def start(message: types.Message, state: FSMContext):
    ...
    await message.answer(
        ...
        f"• используй /poll, чтобы отправить случайный опрос в групповой чат\n\n"
